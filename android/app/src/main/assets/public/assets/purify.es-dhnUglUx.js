/*! @license DOMPurify 3.4.1 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.1/LICENSE */ const {
  entries: yt,
  setPrototypeOf: mt,
  isFrozen: Kt,
  getPrototypeOf: Zt,
...
let { freeze: y, seal: N, create: X } = Object,
...
function s(i, n) {
  const l = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ie;
...
const oe = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 },
  gn = () => (typeof window > 'u' ? null : window),
  hn = (n, l) => {
...
function It() {
  const i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : gn();
  const n = (r) => It(r);
  if (
    ((n.version = '3.4.1'),
    (n.removed = []),
    !i || !i.document || i.document.nodeType !== oe.document || !i.Element)
  )
  ...
  let R = Ot();
  n.isSupported =
    typeof yt == 'function' && typeof ae == 'function' && Ae && Ae.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: se,
    ERB_EXPR: le,
    TMPLIT_EXPR: ce,
  ...
  const Vt = l.createElement('form'),
    et = (e) => e instanceof RegExp || e instanceof Function,
    Ne = function () {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      if (W && W === e) return;
      (!e || typeof e != 'object') && (e = {}),
        (e = I(e)),
        (Q = Xt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? jt : e.PARSER_MEDIA_TYPE),
        (d = Q === 'application/xhtml+xml' ? Pe : ie),
        (_ = u(e, 'ALLOWED_TAGS') && O(e.ALLOWED_TAGS) ? s({}, e.ALLOWED_TAGS, d) : We),
        (A = u(e, 'ALLOWED_ATTR') && O(e.ALLOWED_ATTR) ? s({}, e.ALLOWED_ATTR, d) : Ye),
        (De =
          u(e, 'ALLOWED_NAMESPACES') && O(e.ALLOWED_NAMESPACES)
            ? s({}, e.ALLOWED_NAMESPACES, Pe)
            : Wt),
        (ye =
          u(e, 'ADD_URI_SAFE_ATTR') && O(e.ADD_URI_SAFE_ATTR)
            ? s(I(Qe), e.ADD_URI_SAFE_ATTR, d)
            : Qe),
        (Ze =
          u(e, 'ADD_DATA_URI_TAGS') && O(e.ADD_DATA_URI_TAGS)
            ? s(I(Je), e.ADD_DATA_URI_TAGS, d)
            : Je),
        (w = u(e, 'FORBID_CONTENTS') && O(e.FORBID_CONTENTS) ? s({}, e.FORBID_CONTENTS, d) : Oe),
        (K = u(e, 'FORBID_TAGS') && O(e.FORBID_TAGS) ? s({}, e.FORBID_TAGS, d) : I({})),
        (fe = u(e, 'FORBID_ATTR') && O(e.FORBID_ATTR) ? s({}, e.FORBID_ATTR, d) : I({})),
        (G = u(e, 'USE_PROFILES')
        ...
        (Re = e.KEEP_CONTENT !== !1),
        (J = e.IN_PLACE || !1),
        (Be = ln(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : bt),
        (B = typeof e.NAMESPACE == 'string' ? e.NAMESPACE : P),
        (Ie =
      ...
      if (
        ((m = X(null)),
        u(t, 'tagNameCheck') && et(t.tagNameCheck) && (m.tagNameCheck = t.tagNameCheck),
        u(t, 'attributeNameCheck') &&
          et(t.attributeNameCheck) &&
          (m.attributeNameCheck = t.attributeNameCheck),
        ...
        G &&
          ((_ = s({}, gt)),
          (A = X(null)),
          G.html === !0 && (s(_, At), s(A, ht)),
          G.svg === !0 && (s(_, xe), s(A, ve), s(A, _e)),
          G.svgFilters === !0 && (s(_, ke), s(A, ve), s(A, _e)),
          G.mathMl === !0 && (s(_, Ue), s(A, St), s(A, _e))),
        (k.tagCheck = null),
        (k.attributeCheck = null),
        u(e, 'ADD_TAGS') &&
          (typeof e.ADD_TAGS == 'function'
            ? (k.tagCheck = e.ADD_TAGS)
            : O(e.ADD_TAGS) && (_ === We && (_ = I(_)), s(_, e.ADD_TAGS, d))),
        u(e, 'ADD_ATTR') &&
          (typeof e.ADD_ATTR == 'function'
            ? (k.attributeCheck = e.ADD_ATTR)
            : O(e.ADD_ATTR) && (A === Ye && (A = I(A)), s(A, e.ADD_ATTR, d))),
        u(e, 'ADD_URI_SAFE_ATTR') && O(e.ADD_URI_SAFE_ATTR) && s(ye, e.ADD_URI_SAFE_ATTR, d),
        u(e, 'FORBID_CONTENTS') &&
          O(e.FORBID_CONTENTS) &&
          (w === Oe && (w = I(w)), s(w, e.FORBID_CONTENTS, d)),
        u(e, 'ADD_FORBID_CONTENTS') &&
          O(e.ADD_FORBID_CONTENTS) &&
          (w === Oe && (w = I(w)), s(w, e.ADD_FORBID_CONTENTS, d)),
        Re && (_['#text'] = !0),
        v && s(_, ['html', 'head', 'body']),
        _.table && (s(_, ['tbody']), delete K.tbody),
        ...
        S === void 0 && (S = hn(re, c)),
          S !== null && typeof q == 'string' && (q = S.createHTML(''));
      y && y(e), (W = e);
    },
    tt = s({}, [...xe, ...ke, ...cn]),
    nt = s({}, [...Ue, ...fn]),
          ...
          : e.namespaceURI === pe
            ? t.namespaceURI === P
              ...
              : t.namespaceURI === Te
                ...
                : !!nt[o]
            : e.namespaceURI === P
              ? (t.namespaceURI === Te && !Le[f]) || (t.namespaceURI === pe && !Ie[f])
                ? !1
                : !nt[o] && (Yt[o] || !tt[o])
              : !!(Q === 'application/xhtml+xml' && De[e.namespaceURI])
        : !1;
    },
    C = (e) => {
    ...
    ot = (e) => {
      ...
      return (
        e && o && h.insertBefore(l.createTextNode(o), h.childNodes[0] || null),
        B === P ? vt.call(t, v ? 'html' : 'body')[0] : v ? t.documentElement : h
      );
    },
    it = (e) =>
      kt.call(
    ...
    Me = (e) => typeof Ee == 'function' && e instanceof Ee;
  function x(r, e, t) {
    ee(r, (o) => {
      o.call(n, e, t, W);
    });
  ...
  const rt = (e) => {
      let t = null;
      if ((x(R.beforeSanitizeElements, e, null), Ce(e))) return C(e), !0;
      const o = d(e.nodeName);
      if (
        (x(R.uponSanitizeElement, e, { tagName: o, allowedTags: _ }),
        (Z &&
          e.hasChildNodes() &&
          !Me(e.firstElementChild) &&
          g(/<[/\w!]/g, e.innerHTML) &&
          g(/<[/\w!]/g, e.textContent)) ||
          (Z && e.namespaceURI === P && o === 'style' && Me(e.firstElementChild)) ||
          e.nodeType === oe.progressingInstruction ||
          (Z && e.nodeType === oe.comment && g(/<[/\w]/g, e.data)))
      )
        return C(e), !0;
      if (K[o] || (!(k.tagCheck instanceof Function && k.tagCheck(o)) && !_[o])) {
        if (
          !K[o] &&
          st(o) &&
          ((m.tagNameCheck instanceof RegExp && g(m.tagNameCheck, o)) ||
            (m.tagNameCheck instanceof Function && m.tagNameCheck(o)))
        )
          return !1;
        if (Re && !w[o]) {
      ...
      return (e instanceof ze && !$t(e)) ||
        ...
        : (U &&
            ...
            e.textContent !== t &&
              (te(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
          x(R.afterSanitizeElements, e, null),
          !1);
    },
    at = (e, t, o) => {
                ...
                !(
                  (st(e) &&
                    ...
                    ((m.attributeNameCheck instanceof RegExp && g(m.attributeNameCheck, t)) ||
                      (m.attributeNameCheck instanceof Function && m.attributeNameCheck(t, e)))) ||
                  (t === 'is' &&
    ...
    lt = (e) => {
      ...
      for (; f--; ) {
        const h = t[f],
          { name: p, namespaceURI: D, value: L } = h,
          M = d(p),
          we = L;
        ...
        if (
          ...
          x(R.uponSanitizeAttribute, e, o),
          (E = o.attrValue),
          qe && (M === 'id' || M === 'name') && dt(E, Ke) !== 0 && (F(p, e), (E = Ke + E)),
          Z &&
            g(
  ...
  return (
    (n.sanitize = function (r) {
      ...
      if (
        ((be = !r),
        be && (r = '<!-->'),
        typeof r != 'string' && !Me(r) && ((r = sn(r)), typeof r != 'string'))
      )
      ...
      if ((he || Ne(e), (n.removed = []), typeof r == 'string' && (J = !1), J)) {
        ...
        (t = ot('<!---->')),
          (o = t.ownerDocument.importNode(r, !0)),
          (o.nodeType === oe.element && o.nodeName === 'BODY') || o.nodeName === 'HTML'
            ? (t = o)
            : t.appendChild(o);
      else {
      ...
      return (
        v &&
          ...
          g(Dt, t.ownerDocument.doctype.name) &&
          (D =
            '<!DOCTYPE ' +
            t.ownerDocument.doctype.name +
            `>
` +
    ...
    (n.setConfig = function () {
      const r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      Ne(r), (he = !0);
    }),
    (n.clearConfig = () => {
      (W = null), (he = !1);
    }),
    (n.isValidAttribute = (r, e, t) => {
      W || Ne({});
      const o = d(r),
        f = d(e);
      return at(o, f, t);
