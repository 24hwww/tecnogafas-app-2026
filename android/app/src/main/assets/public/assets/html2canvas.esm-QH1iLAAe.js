...
***************************************************************************** */ var mr = (
  ...
  (mr =
    ...
    ((t, r) => {
      for (var B in r) Object.hasOwn(r, B) && (t[B] = r[B]);
    })),
  mr(e, A)
);
function tA(e, A) {
    ...
    (Lr =
      ...
      function (A) {
        for (var t, r = 1, B = arguments.length; r < B; r++) {
          t = arguments[r];
          for (var n in t) Object.hasOwn(t, n) && (A[n] = t[n]);
        }
        return A;
      }),
...
var cA = (() => {
    ...
    return (
      ...
      (e.fromClientRect = (A, t) =>
        new e(t.left + A.windowBounds.left, t.top + A.windowBounds.top, t.width, t.height)),
      (e.fromDOMRectList = (A, t) => {
        var r = Array.from(t).find((B) => B.width !== 0);
        return r
  ...
  ze = (e, A) => cA.fromClientRect(e, A.getBoundingClientRect()),
  an = (e) => {
    var A = e.body,
      t = e.documentElement;
...
var Qn = (e) => {
  ...
  En = dn - 1,
  at = (e, A, t) =>
    e.slice ? e.slice(A, t) : new Uint16Array(Array.prototype.slice.call(e, A, t)),
  Hn = (e, A, t) =>
    e.slice ? e.slice(A, t) : new Uint32Array(Array.prototype.slice.call(e, A, t)),
  pn = (e, A) => {
    var t = Qn(e),
...
var yn =
  ...
  Nn = (e, A) => {
    ...
    (A.wordBreak === 'break-all' || A.wordBreak === 'break-word') &&
      (B = B.map((i) => ([j, LA, iB].indexOf(i) !== -1 ? Qe : i)));
    var s =
      A.wordBreak === 'keep-all' ? n.map((i, a) => i && e[a] >= 19968 && e[a] <= 40959) : void 0;
    return [r, B, s];
  },
  Xn = (() => {
    function e(A, t, r, B) {
  ...
  Es = 90,
  J = (e) => e >= gB && e <= 57,
  Hs = (e) => e >= 55296 && e <= 57343,
  MA = (e) => J(e) || (e >= CB && e <= lB) || (e >= wB && e <= Us),
  ps = (e) => e >= wB && e <= hs,
  Is = (e) => e >= CB && e <= Es,
  vs = (e) => ps(e) || Is(e),
  ys = (e) => e >= is,
  ...
  _e = (e) => vs(e) || ys(e) || e === jn,
  dt = (e) => _e(e) || J(e) || e === Z,
  Ks = (e) => (e >= ws && e <= cs) || e === Cs || (e >= us && e <= ls) || e === fs,
  UA = (e, A) => (e !== ne ? !1 : A !== Xe),
  Ke = (e, A, t) => (e === Z ? _e(A) || UA(A, t) : _e(e) ? !0 : !!(e === ne && UA(e, A))),
  Cr = (e, A, t) => (e === DA || e === Z ? (J(A) ? !0 : A === ge && J(t)) : J(e === ge ? A : e)),
  ms = (e) => {
    var A = 0,
      t = 1;
  ...
  UB = (() => {
    ...
    return (
      ...
      (e.parseValue = (A) => e.create(A).parseComponentValue()),
      (e.parseValues = (A) => e.create(A).parseComponentValues()),
  ...
  D = (e) => e.type === 20,
  Zs = (e) => e.type === 0,
  Xr = (e, A) => D(e) && e.value === A,
  FB = (e) => e.type !== 31,
  PA = (e) => e.type !== 31 && e.type !== 4,
  sA = (e) => {
    var A = [],
      t = [];
    return (
  ...
  qs = (e, A) =>
    (A === 11 && e.type === 12) || (A === 28 && e.type === 29) ? !0 : A === 2 && e.type === 3,
  pA = (e) => e.type === 17 || e.type === 15,
  M = (e) => e.type === 16 || pA(e),
  hB = (e) => (e.length > 1 ? [e[0], e[1]] : [e[0]]),
  ...
  IB = (e) => e.type === 15 && (e.unit === dB || e.unit === EB || e.unit === HB || e.unit === pB),
  vB = (e) => {
    var A = e
      .filter(D)
      .map((t) => t.value)
  ...
  dA = (e, A, t, r) => ((e << 24) | (A << 16) | (t << 8) | (Math.round(r * 255) << 0)) >>> 0,
  Et = (e, A) => {
...
var pt = (e, A) => {
  ...
  se = (e, A) => EA.parse(e, UB.create(A).parseComponentValue()),
  wA = {
  ...
  oa = {
    ...
    parse: (e, A) => {
      ...
      return t.type === 20 && t.value === 'none'
        ? []
        : A.filter((r) => PA(r) && ia(r)).map((r) => At.parse(e, r));
    },
  },
  Qa = {
...
var Ca = {
    ...
    prefix: !1,
    type: 1,
    parse: (e, A) => sA(A).map((t) => t.filter(ua)),
  },
  ua = (e) => D(e) || M(e),
  rr = (e) => ({
    name: 'border-' + e + '-color',
  ...
  Ta = {
    ...
    prefix: !1,
    type: 1,
    parse: (e, A) => A.filter(D).reduce((t, r) => t | Sa(r.value), 0),
  },
  Sa = (e) => {
    switch (e) {
      case 'block':
  ...
  Ma = {
    ...
    type: 0,
    parse: (e, A) =>
      A.type === 20 && A.value === 'normal' ? 0 : A.type === 17 || A.type === 15 ? A.number : 0,
  },
  Je;
((e) => {
...
var Ga = {
  ...
  yt = (e, A) =>
    D(e) && e.value === 'normal' ? 1.2 * A : e.type === 17 ? A * e.number : M(e) ? b(e, A) : A,
  Va = {
    name: 'list-style-image',
    initialValue: 'none',
    type: 0,
    prefix: !1,
    parse: (e, A) => (A.type === 20 && A.value === 'none' ? null : At.parse(e, A)),
  },
  Na = {
  ...
  sr = (e) => ({ name: 'margin-' + e, initialValue: '0', prefix: !1, type: 4 }),
  Xa = sr('top'),
  _a = sr('right'),
  Ja = sr('bottom'),
  Pa = sr('left'),
  ...
  ti = (e) => {
    var A = e.filter((t) => t.type === 17).map((t) => t.number);
    return A.length === 6 ? A : null;
  },
  Bi = (e) => {
    var A = e.filter((a) => a.type === 17).map((a) => a.number),
      t = A[0],
      r = A[1];
    A[2], A[3];
    var B = A[4],
...
var oi = {
  ...
  li = {
    ...
    type: 1,
    prefix: !1,
    parse: (e, A) => A.filter(D).map((t) => t.value),
  },
  Ui = {
    name: 'font-style',
    initialValue: 'normal',
  ...
  Ei = {
    ...
    prefix: !1,
    type: 1,
    parse: (e, A) => A.filter(Ce).map((t) => OB.parse(e, t)),
  },
  Hi = {
    name: 'quotes',
    initialValue: 'none',
  ...
  aA = (() => {
    function e(A, t) {
      ...
      (this.styles = new Ki(A, window.getComputedStyle(t, null))),
        Yr(t) &&
          (this.styles.animationDuration.some((r) => r > 0) && (t.style.animationDuration = '0s'),
...
var qi = 1,
  ...
  ao = () => typeof new Image().crossOrigin < 'u',
  io = () => typeof new XMLHttpRequest().responseType == 'string',
  oo = (e) => {
    var A = new Image(),
  ...
  Nt = (e) => e[0] === 0 && e[1] === 255 && e[2] === 0 && e[3] === 255,
  Qo = (e) => {
    ...
    return (
      ...
      Xt(s)
        ...
        .then((i) => (r.drawImage(i, 0, 0), Nt(r.getImageData(0, 0, t, t).data)))
        .catch(() => !1)
    );
  },
  Pr = (e, A, t, r, B) => {
  ...
  co = (e, A) => {
    if (N.SUPPORT_NATIVE_TEXT_SEGMENTATION) {
      ...
      return Array.from(t.segment(e)).map((r) => r.segment);
    }
    return lo(e, A);
  },
  Co = (e, A) => (A.letterSpacing !== 0 ? rt(e) : co(e, A)),
  ...
  Fo = /(^|\s|:|-|\(|\))([a-z])/g,
  ho = (e, A, t) => (e.length > 0 ? A + t.toUpperCase() : e),
  GB = ((e) => {
    tA(A, e);
    function A(t, r) {
  ...
  Ve = (e, A, t, r) => {
    for (var B = A.firstChild, n = void 0; B; B = n)
      if (((n = B.nextSibling), YB(B) && B.data.trim().length > 0))
        ...
        if (jB(B) && B.assignedNodes) B.assignedNodes().forEach((i) => Ve(e, i, t, r));
        else {
          var s = PB(e, B);
          s.styles.isVisible() &&
  ...
  mo = (e) => e.isPositioned() || e.isFloating(),
  YB = (e) => e.nodeType === Node.TEXT_NODE,
  _A = (e) => e.nodeType === Node.ELEMENT_NODE,
  Yr = (e) => _A(e) && typeof e.style < 'u' && !Ne(e),
  Ne = (e) => typeof e.className == 'object',
  Lo = (e) => e.tagName === 'LI',
  Do = (e) => e.tagName === 'OL',
  bo = (e) => e.tagName === 'INPUT',
  xo = (e) => e.tagName === 'HTML',
  WB = (e) => e.tagName === 'svg',
  Bt = (e) => e.tagName === 'BODY',
  ZB = (e) => e.tagName === 'CANVAS',
  Pt = (e) => e.tagName === 'VIDEO',
  Wr = (e) => e.tagName === 'IMG',
  qB = (e) => e.tagName === 'IFRAME',
  kt = (e) => e.tagName === 'STYLE',
  To = (e) => e.tagName === 'SCRIPT',
  Ye = (e) => e.tagName === 'TEXTAREA',
  We = (e) => e.tagName === 'SELECT',
  jB = (e) => e.tagName === 'SLOT',
  Yt = (e) => e.tagName.indexOf('-') > 0,
  So = (() => {
    function e() {
      this.counters = {};
    }
    return (
      ...
      (e.prototype.pop = function (A) {
        A.forEach((r) => this.counters[r].pop());
      }),
      (e.prototype.parse = function (A) {
        var r = A.counterIncrement,
          B = A.counterReset,
          n = !0;
        r !== null &&
          r.forEach((i) => {
            var a = this.counters[i.counter];
            a &&
              i.increment !== 0 &&
        ...
        return (
          n &&
            B.forEach((i) => {
              var a = this.counters[i.counter];
              s.push(i.counter), a || (a = this.counters[i.counter] = []), a.push(i.reset);
            }),
          s
        );
      }),
  ...
  T = (e, A, t, r, B) => {
    var n = t - A + 1;
    return (e < 0 ? '-' : '') + (zB(Math.abs(e), n, r, (s) => S(Math.floor(s % n) + A)) + B);
  },
  mA = (e, A, t) => {
    t === void 0 && (t = '. ');
    var r = A.length;
    return zB(Math.abs(e), r, !1, (B) => A[Math.floor(B % r)]) + t;
  },
  NA = 1,
  lA = 2,
  fA = 4,
  ...
  $t = (() => {
    ...
    return (
      ...
      (e.prototype.createCustomElementClone = (A) => {
      ...
      (e.prototype.createStyleClone = function (A) {
        try {
          ...
          if (t && t.cssRules) {
            var r = [].slice
                .call(t.cssRules, 0)
                .reduce((n, s) => (s && typeof s.cssText == 'string' ? n + s.cssText : n), ''),
              B = A.cloneNode(!1);
      ...
      (e.prototype.cloneChildNodes = function (A, t, r) {
        for (var n = A.shadowRoot ? A.shadowRoot.firstChild : A.firstChild; n; n = n.nextSibling)
          if (_A(n) && jB(n) && typeof n.assignedNodes == 'function') {
            ...
            s.length && s.forEach((i) => this.appendChildNode(t, i, r));
                ...
                if (g.type === 0) o.appendChild(i.createTextNode(g.value));
                  ...
                  if (g.name === 'attr') {
                    ...
                    var c = g.values.filter(PA),
                      ...
                      H = c[1];
                    if (C && D(C)) {
                      var h = this.counters.getCounterValue(C.value),
                        F = H && D(H) ? _r.parse(this.context, H.value) : 3;
                    ...
                    var K = g.values.filter(PA),
                      ...
                      H = K[2];
                    if (C && D(C)) {
                      var d = this.counters.getCounterValues(C.value),
                        l = H && D(H) ? _r.parse(this.context, H.value) : 3,
                        v = p && p.type === 0 ? p.value : '',
                        y = d.map((k) => we(k, l, !1)).join(v);
                  ...
                  switch (g.value) {
                    case 'open-quote':
                      o.appendChild(i.createTextNode(mt(a.quotes, this.quoteDepth++, !0)));
                      break;
                    case 'close-quote':
                      o.appendChild(i.createTextNode(mt(a.quotes, --this.quoteDepth, !1)));
                      break;
                    default:
      ...
      (e.destroy = (A) => (A.parentNode ? (A.parentNode.removeChild(A), !0) : !1)),
      e
    );
  })(),
  oe;
...
var Go = (e, A) => {
  ...
  Vo = (e) => Promise.all([].slice.call(e.images, 0).map(Ro)),
  No = (e) =>
    new Promise((A, t) => {
  ...
  An = (() => {
    ...
    return (
      ...
      (e.isSameOrigin = (A) => e.getOrigin(A) === e._origin),
      (e.setContext = (A) => {
  ...
  qo = (() => {
    ...
    return (
      (e.prototype.addImage = function (A) {
        ...
        return (
          this.has(A) || ((yr(A) || AQ(A)) && (this._cache[A] = this.loadImage(A)).catch(() => {})),
          t
        );
      }),
                  ...
                  [
                    ...
                    new Promise((a, o) => {
                      ...
                      (Q.onload = () => a(Q)),
                        ...
                        (Q.src = n),
                        Q.complete === !0 && setTimeout(() => a(Q), 500),
                        s._options.imageTimeout > 0 &&
                          setTimeout(
                            () => o('Timed out (' + s._options.imageTimeout + 'ms) loading image'),
      ...
      (e.prototype.proxy = function (A) {
        ...
        return new Promise((n, s) => {
          ...
          (a.onload = () => {
            if (a.status === 200)
              if (i === 'text') n(a.response);
                ...
                g.addEventListener('load', () => n(g.result), !1),
                  g.addEventListener('error', (w) => s(w), !1),
          ...
          if (
            ...
            var Q = this._options.imageTimeout;
            (a.timeout = Q), (a.ontimeout = () => s('Timed out (' + Q + 'ms) proxying ' + B));
          }
          a.send();
        });
      }),
  ...
  $o = /^data:image\/.*/i,
  AQ = (e) => N.SUPPORT_SVG_DRAWING || !rQ(e),
  vr = (e) => $o.test(e),
  eQ = (e) => zo.test(e),
  yr = (e) => e.substr(0, 4) === 'blob',
  rQ = (e) => e.substr(-3).toLowerCase() === 'svg' || jo.test(e),
  u = (() => {
    function e(A, t) {
  ...
  RA = (e, A, t) => new u(e.x + (A.x - e.x) * t, e.y + (A.y - e.y) * t),
  Te = (() => {
    function e(A, t, r, B) {
      (this.type = 1),
        (this.start = A),
...
var x = (e, A, t, r, B) => {
  ...
  en = (e) => e.type === 1,
  iQ = (e) => e.type === 2,
  eB = (e, A) => (e.length === A.length ? e.some((t, r) => t === A[r]) : !1),
  oQ = (e, A, t, r, B) =>
    e.map((n, s) => {
      switch (s) {
        case 0:
  ...
  tn = (() => {
    ...
    return (
      (e.prototype.getEffects = function (A) {
        ...
        return B.filter((a) => G(a.target, A));
      }),
      e
    );
  })(),
  jr = (e, A, t, r) => {
    e.container.elements.forEach((B) => {
      var n = G(B.flags, 4),
        s = G(B.flags, 2),
        i = new tn(B, e);
      ...
      if (n || s) {
        ...
        if (B.styles.isPositioned() || B.styles.opacity < 1 || B.styles.isTransformed()) {
          ...
          if (g < 0) {
            var w = 0;
            o.negativeZIndex.some((c, C) =>
              g > c.element.container.styles.zIndex.order ? ((w = C), !1) : w > 0,
            ),
              o.negativeZIndex.splice(w, 0, Q);
          } else if (g > 0) {
            var f = 0;
            o.positiveZIndex.some((c, C) =>
              g >= c.element.container.styles.zIndex.order ? ((f = C + 1), !1) : f > 0,
            ),
  ...
  CQ = (e, A) => (e === 0 ? A.bounds : e === 2 ? je(A) : nn(A)),
  uQ = (e, A) => (e === 0 ? A.bounds : e === 2 ? je(A) : nn(A)),
  Kr = (e, A, t) => {
  ...
  dQ = ((e) => {
    ...
    return (
      (A.prototype.applyEffects = function (t) {
        ...
        t.forEach((B) => this.applyEffect(B));
      }),
      ...
      (A.prototype.renderTextWithLetterSpacing = function (t, r, B) {
        if (r === 0) this.ctx.fillText(t.text, t.bounds.left, t.bounds.top + B);
          ...
          s.reduce(
            (i, a) => (
              this.ctx.fillText(a, i, t.bounds.top + B), i + this.ctx.measureText(a).width
            ),
            t.bounds.left,
          );
        }
      }),
      (A.prototype.createFontStyle = (t) => {
        var r = t.fontVariant.filter((s) => s === 'normal' || s === 'small-caps').join(''),
                    ...
                    case 0: {
                      ...
                      H.length &&
                        ...
                        r.textDecorationLine.length &&
                          ...
                          r.textDecorationLine.forEach((h) => {
                            switch (h) {
                              case 1:
                                w.ctx.fillRect(
                                  c.bounds.left,
      ...
      (A.prototype.formatPath = function (t) {
        t.forEach((B, n) => {
          var s = $(B) ? B.start : B;
          n === 0 ? this.ctx.moveTo(s.x, s.y) : this.ctx.lineTo(s.x, s.y),
            $(B) &&
                        ...
                        case 5:
                          sa(Q)
                            ? ((c = Kr(t, r, [null, null, null])),
                              ...
                              It(Q.stops, H).forEach((YA) => v.addColorStop(YA.stop, R(YA.color))),
                              (l.fillStyle = v),
                              l.fillRect(0, 0, L, V),
                              L > 0 &&
                                V > 0 &&
                            ...
                            : aa(Q) &&
                              ...
                              BA > 0 &&
                                ...
                                It(Q.stops, BA * 2).forEach((YA) =>
                                  vA.addColorStop(YA.stop, R(YA.color)),
                                ),
                                n.path(O),
                                (n.ctx.fillStyle = vA),
                                BA !== uA
  ...
  EQ = (e) =>
    e instanceof _B || e instanceof XB ? !0 : e instanceof tt && e.type !== ke && e.type !== Pe,
  HQ = (e, A) => {
    switch (e) {
      case 0:
        return Ze(A);
  ...
  vQ = (e) =>
    /iPhone OS 15_(0|1)/.test(window.navigator.userAgent)
      ? e.filter((A) => IQ.indexOf(A) === -1)
      : e,
  yQ = ((e) => {
    tA(A, e);
    function A(t, r) {
