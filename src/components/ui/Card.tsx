...
>(({ className, variant = 'default', interactive = false, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={cn(variants[variant], interactiveClasses, className)} {...props} />
  );
});
...
const CardTitle = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn('card-title text-lg', className)} {...props} />
  ),
);
...
const CardFooter = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('card-body pt-0 flex-row items-center', className)} {...props} />
  ),
);
