  ...
  return (
    <div className="p-6 bg-surface text-on-surface min-h-screen">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        ...
        <button className="bg-primary text-on-primary p-3 rounded-lg font-bold text-sm hover:scale-[1.02] transition-transform" onClick={() => runTest('getOrders', () => apiService.getOrders(1, 25, sellerId))}>Get Orders</button>
        ...
        <button className="bg-primary text-on-primary p-3 rounded-lg font-bold text-sm hover:scale-[1.02] transition-transform" onClick={() => runTest('getEvents', () => apiService.getEvents(undefined, sellerId))}>Get Events</button>
