import { Bell, Info, MessageSquare, Send } from "lucide-react";
...
export default function Notifications() {
	...
	const [_isAcking, _setIsAcking] = useState<any[]>([]);

	const handleSend = async () => {
		const userId = parseInt(targetUser, 10);
		if (Number.isNaN(userId) || !messageContent) return;
