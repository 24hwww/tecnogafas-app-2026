      ...
      <div className="space-y-6">
        ...
        <section className="space-y-4">
          <h3 className="text-h3 flex items-center gap-2">
            <Key size={20} className="text-on-surface-variant" /> Cuenta
          </h3>
        ...
        <section className="space-y-4">
          <h3 className="text-h3 flex items-center gap-2">
            <Bell size={20} className="text-on-surface-variant" /> Notificaciones
          </h3>
        ...
        <section className="space-y-4">
          <h3 className="text-h3 flex items-center gap-2">
            <Palette size={20} className="text-on-surface-variant" /> Apariencia
          </h3>
          <div className="m3-card space-y-6">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    theme === 'light'
                      ...
                      : 'bg-surface-variant/30 border-outline/10 text-on-surface-variant',
                  )}
                >
                  <Sun size={20} />
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <div
                  className="w-12 h-12 rounded-full shadow-inner relative overflow-hidden border-2 border-outline/20 shrink-0"
        ...
        <section className="space-y-4">
          <h3 className="text-h3 flex items-center gap-2">
            <Smartphone size={20} className="text-on-surface-variant" /> Sistema
          </h3>
          <div className="m3-card">
            {kodular.isKodular ? (
