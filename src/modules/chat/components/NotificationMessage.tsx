...
const TYPE_COLORS: Record<string, string> = {
  ...
  alert: 'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-200 dark:border-yellow-800',
  system: 'bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700',
  notification: 'bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800',
};
